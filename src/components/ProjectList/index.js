...
const ProjectList = () => {
  const [photos] = useState([
    {
      ...
      git_hub: "https://github.com/manjula-guneratne/walk-my-dog",
      description:
      ...
      technologies:
        "Apollo/React-Hooks,Apollo-Boost, Graphql, React, JWT-Decode, React-Scripts, Semantic-UI, AWS S3, Apollo-Server-Express, Bcrypt, Express.js, JsonWebToken, Mongoose, Stripe",
    },
    {
      name: "coders_bay",
      ...
      git_hub: "https://github.com/manjula-guneratne/codersbay",
      description:
      ...
      technologies:
        "JavaScript, Express, Node.js, Bootstrap, Socket.io, MySQL2, bcrypt, Express Handlebars, Sequelize",
    },
    {
      ...
      git_hub: "https://github.com/manjula-guneratne/project1-group07",
      description:
      ...
      technologies:
        "HTML, CSS, CSS Frameworks (Materialize CSS and Semantic UI), Javascript and API's",
    },
    {
      name: "nosql",
      image_path: "nosql.c8bbcdcf",
      category: "portfolio",
      link: "https://github.com/manjula-guneratne/social-media-Manjula",
      git_hub: "https://github.com/manjula-guneratne/social-media-Manjula",
      description:
    ...
    },
    {
      ...
      category: "portfolio",
      link: "https://manjula-guneratne.github.io/NoteTaker-Manjula/",
      git_hub: "https://manjula-guneratne.github.io/NoteTaker-Manjula/",
      description:
    ...
    },
    {
      ...
      category: "portfolio",
      link: "https://github.com/manjula-guneratne/e-commerce-Manjula",
      git_hub: "https://github.com/manjula-guneratne/e-commerce-Manjula",
      description:
        "To create a website to monitor and manupulate store inventory and manage customer information.",
      technologies:
        "JavaScript, Node, npm, Express, dotenv, sequelize, express, routes",
    },
    {
      name: "timed_quiz",
      image_path: "timed_quiz.1b938e9f",
      category: "portfolio",
      link: "https://manjula-guneratne.github.io/timed-quiz-Manjula/",
      git_hub: "https://github.com/manjula-guneratne/timed-quiz-Manjula",
      description: "Creating a quiz using DOM principles.",
  ...
  const setPath = (param) => {
    switch (param) {
      case "coders_bay":
        return coders_bay;
      case "covid_positivity":
        return covid_positivity;
      case "dog_dash":
        return dog_dash;
      case "nosql":
        return nosql;
            ...
            <div>
              ...
              <div className="flex-container">
                ...
                <div className="flex-links">
                  <p>
                    <u>Associated links</u>
                  </p>
                  <a href={image.git_hub} target="_blank" rel="noreferrer">
                    Git Hub
                  </a>
                  <br />
                  <br />
